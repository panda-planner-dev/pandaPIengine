...
#define CMDLINE_PARSER_PACKAGE "planVerifier"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "planVerifier"
#endif
...
struct gengetopt_args_info
{
  ...
  char * htn_arg;	/**< @brief the path to the input HTN problem file.  */
  char * htn_orig;	/**< @brief the path to the input HTN problem file original value given at command line.  */
  const char *htn_help; /**< @brief the path to the input HTN problem file help description.  */
